...
export interface WhatsAppOptions {accessToken:string;phoneNumberId:string;apiVersion:string;transport?:'meta'|'emulator';apiBaseUrl?:string;writesEnabled?:boolean;allowedRecipients?:readonly string[];mediaHosts?:string[];maxMediaBytes?:number;timeoutMs?:number;emulatorMediaDir?:string}
