...
import { DEMO_FIXTURE_SOURCE, demoPhoneNumber } from '../src/demo/demo-fixture.js';
...
const candidates=listed.filter((value):value is {id:string;version:number;source:string;telefono:string}=>Boolean(value&&typeof value==='object'&&typeof (value as any).id==='string'&&typeof (value as any).version==='number'&&(value as any).source===DEMO_FIXTURE_SOURCE&&(value as any).telefono===demoPhoneNumber()));
