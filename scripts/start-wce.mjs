...
const children = [
  spawn(process.execPath, ['bridge/index.js'], { cwd: wceRoot, env: { ...shared, BOT_WEBHOOK_URL: 'http://127.0.0.1:4720/webhooks/whatsapp', WCE_PHONE_NUMBER_ID: '999000000000', WCE_SENDER_PHONE: '34663094035', WCE_BUSINESS_ACCOUNT_ID: 'wce-local-business', WCE_APP_SECRET: shared.WA_APP_SECRET, WCE_BRIDGE_PORT: '3001' }}),
...
console.log(JSON.stringify({ ui: 'http://127.0.0.1:8080', bridge: 'http://127.0.0.1:3001', apod: 'http://127.0.0.1:4720', recipient: '34663094035', externalMetaCalls: false }));
