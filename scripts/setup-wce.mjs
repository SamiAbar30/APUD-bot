...
const values = {
  ...
  SEDE_ENABLED: 'false', SEDE_RECIPE_FILE: '', AIRAM_FULL_NAME: source.AIRAM_FULL_NAME || '', REPRESENTATIVES_FILE: source.REPRESENTATIVES_FILE || '', TUTORIAL_FILE: source.TUTORIAL_FILE || '', CONSENT_VERSION: process.env.WCE_CONSENT_VERSION ?? (source.CONSENT_VERSION || 'DEMO-SIMULADOR'), CONSENT_TEXT_FILE: '', REVOCATION_GUIDE_FILE: source.REVOCATION_GUIDE_FILE || '', REVOCATION_SCREENSHOTS_FILE: source.REVOCATION_SCREENSHOTS_FILE || '', GEO_CATALOG_FILE: '', PUBLIC_BASE_URL: 'http://127.0.0.1:4720', CARMEN_USER_ID: '', DEMO_DATA_PROVENANCE: 'WCE_LOCAL_ONLY',
};
